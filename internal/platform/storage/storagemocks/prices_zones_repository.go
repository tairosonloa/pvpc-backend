...
func (_m *PricesZonesRepository) GetAll(ctx context.Context) ([]domain.PricesZone, error) {
	ret := _m.Called(ctx)

	var r0 []domain.PricesZone
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]domain.PricesZone, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []domain.PricesZone); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.PricesZone)
		}
	}
...
func (_c *PricesZonesRepository_GetAll_Call) Return(_a0 []domain.PricesZone, _a1 error) *PricesZonesRepository_GetAll_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PricesZonesRepository_GetAll_Call) RunAndReturn(run func(context.Context) ([]domain.PricesZone, error)) *PricesZonesRepository_GetAll_Call {
	_c.Call.Return(run)
	return _c
}

// GetByExternalID provides a mock function with given fields: ctx, externalID
func (_m *PricesZonesRepository) GetByExternalID(ctx context.Context, externalID string) (domain.PricesZone, error) {
	ret := _m.Called(ctx, externalID)

	var r0 domain.PricesZone
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (domain.PricesZone, error)); ok {
		return rf(ctx, externalID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) domain.PricesZone); ok {
...
func (_c *PricesZonesRepository_GetByExternalID_Call) Return(_a0 domain.PricesZone, _a1 error) *PricesZonesRepository_GetByExternalID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PricesZonesRepository_GetByExternalID_Call) RunAndReturn(run func(context.Context, string) (domain.PricesZone, error)) *PricesZonesRepository_GetByExternalID_Call {
	_c.Call.Return(run)
	return _c
}

// GetByID provides a mock function with given fields: ctx, id
func (_m *PricesZonesRepository) GetByID(ctx context.Context, id domain.PricesZoneID) (domain.PricesZone, error) {
	ret := _m.Called(ctx, id)

	var r0 domain.PricesZone
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.PricesZoneID) (domain.PricesZone, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, domain.PricesZoneID) domain.PricesZone); ok {
		r0 = rf(ctx, id)
	} else {
		r0 = ret.Get(0).(domain.PricesZone)
	}

	if rf, ok := ret.Get(1).(func(context.Context, domain.PricesZoneID) error); ok {
		r1 = rf(ctx, id)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *PricesZonesRepository_GetByID_Call) Run(run func(ctx context.Context, id domain.PricesZoneID)) *PricesZonesRepository_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(domain.PricesZoneID))
	})
	return _c
}

func (_c *PricesZonesRepository_GetByID_Call) Return(_a0 domain.PricesZone, _a1 error) *PricesZonesRepository_GetByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PricesZonesRepository_GetByID_Call) RunAndReturn(run func(context.Context, domain.PricesZoneID) (domain.PricesZone, error)) *PricesZonesRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
